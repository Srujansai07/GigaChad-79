...
export default function Profile() {
    const { user, levelInfo, resetProgress } = useUserStore();
        ...
        <div className="p-4 space-y-6">
            ...
            <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-1 text-aura mt-2">
                    <Zap size={20} />
                    <span className="text-xl font-bold">{user.aura.toLocaleString()} Aura</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="bg-surface p-4 rounded-lg text-center">
                    ...
                    <p className="text-2xl font-bold text-white">{user.tasksCompleted}</p>
                ...
                <div className="bg-surface p-4 rounded-lg text-center">
                    ...
                    <p className="text-2xl font-bold text-white">{user.strictModeCount}</p>
